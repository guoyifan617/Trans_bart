...
import cnfg.plm.bart.base_zh2zang as cnfg
...
fvocab_t = '/home/yfguo/CCMT_model/bart_wright/transformer-edge/cache/24k_cache/zh2zang_bart/rs1/tgtvcb.txt'
vcbt, nwordt = ldvocab(fvocab_t)
print(nwordt)
print(vcbt)
nwordi = cn_vocab_size
