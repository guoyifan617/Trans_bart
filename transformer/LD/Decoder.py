...
class DecoderLayer(DecoderLayerBase):
	...
	def forward(self, inpute, inputh, inputo, src_pad_mask=None, chk_pad_mask=None, tgt_pad_mask=None, query_unit=None, **kwargs):
...
class Decoder(DecoderBase):
	...
	def forward(self, inpute, inputh, inputo, src_pad_mask=None, chk_pad_mask=None, **kwargs):
	...
	def greedy_decode(self, inpute, inputh, src_pad_mask=None, chk_pad_mask=None, max_len=512, fill_pad=False, sample=False, **kwargs):
	...
	def beam_decode(self, inpute, inputh, src_pad_mask=None, chk_pad_mask=None, beam_size=8, max_len=512, length_penalty=0.0, return_all=False, clip_beam=clip_beam_with_lp, fill_pad=False, **kwargs):
