...
from modules.TA import PositionwiseFF, ResCrossAttn
...
class DecoderLayer(DecoderLayerBase):
	...
	def forward(self, inpute, inputh, inputo, src_pad_mask=None, tgt_pad_mask=None, query_unit=None, **kwargs):
...
class Decoder(DecoderBase):
	...
	def __init__(self, isize, nwd, num_layer, fhsize=None, dropout=0.0, attn_drop=0.0, act_drop=None, emb_w=None, num_head=8, xseql=cache_len_default, ahsize=None, norm_output=True, bindemb=False, forbidden_index=None, share_layer=False, **kwargs):
	...
	def forward(self, inpute, inputh, inputo, src_pad_mask=None, **kwargs):
	...
	def beam_decode(self, inpute, inputh, src_pad_mask=None, beam_size=8, max_len=512, length_penalty=0.0, return_all=False, clip_beam=clip_beam_with_lp, fill_pad=False, **kwargs):
	...
	def decode(self, inpute, inputh, src_pad_mask, beam_size=1, max_len=512, length_penalty=0.0, fill_pad=False, **kwargs):

		return self.beam_decode(inpute, inputh, src_pad_mask, beam_size, max_len, length_penalty, fill_pad=fill_pad, **kwargs) if beam_size > 1 else self.greedy_decode(inpute, inputh, src_pad_mask, max_len, fill_pad=fill_pad, **kwargs)
