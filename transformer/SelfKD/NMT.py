...
class NMT(NMTBase):
	...
	def __init__(self, isize, snwd, tnwd, num_layer, fhsize=None, dropout=0.0, attn_drop=0.0, global_emb=False, num_head=8, xseql=cache_len_default, ahsize=None, norm_output=True, bindDecoderEmb=True, forbidden_index=None, kd_layers=None, enable_proj=True, num_topk=64, T=1.0, min_T=None, min_gold_p=None, mix_kd=True, iter_kd=True, remove_gold=False, **kwargs):
		...
		self.enc = Encoder(isize, snwd, enc_layer, fhsize=fhsize, dropout=dropout, attn_drop=attn_drop, num_head=num_head, xseql=xseql, ahsize=ahsize, norm_output=norm_output, kd_layers=kd_enc_layers, enable_proj=enable_proj)
