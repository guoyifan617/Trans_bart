...
from transformer.PLM.T5.Decoder import Decoder
from transformer.PLM.T5.Encoder import Encoder
from utils.fmt.parser import parse_double_value_tuple, parse_none
from utils.plm.base import set_ln_ieps
from utils.plm.t5 import extend_rel_emb
...
class NMT(NMTBase):
	...
	def __init__(self, isize, snwd, tnwd, num_layer, fhsize=None, dropout=0.0, attn_drop=0.0, act_drop=None, global_emb=False, num_head=8, xseql=cache_len_default, ahsize=None, norm_output=True, bindDecoderEmb=True, forbidden_index=None, model_name=("encoder", "decoder",), **kwargs):
