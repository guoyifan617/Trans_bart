...
from transformer.AGG.ReentEncoder import Encoder as EncoderBase
...
class R2EncoderLayer(nn.Module):
	...
	def __init__(self, isize, fhsize=None, dropout=0.0, attn_drop=0.0, num_head=8, ahsize=None, num_sub=1, num_unit=1, **kwargs):
		...
		super(R2EncoderLayer, self).__init__()
...
class EncoderLayer(nn.Module):
	...
	def __init__(self, isize, fhsize=None, dropout=0.0, attn_drop=0.0, num_head=8, ahsize=None, num_sub3=1, num_sub=1, num_unit=1, **kwargs):
		...
		self.nets = nn.ModuleList([R2EncoderLayer(isize, _fhsize, dropout, attn_drop, num_head, _ahsize, num_sub, num_unit) for i in range(num_sub3)])
...
class Encoder(EncoderBase):
	...
	def __init__(self, isize, nwd, num_layer, fhsize=None, dropout=0.0, attn_drop=0.0, num_head=8, xseql=cache_len_default, ahsize=None, norm_output=False, num_sub3=1, num_sub=1, num_unit=1, **kwargs):
