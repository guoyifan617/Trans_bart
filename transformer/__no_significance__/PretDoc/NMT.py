...
class NMT(NMTBase):
	...
	def __init__(self, isize, snwd, pnwd, tnwd, num_layer, fhsize=None, dropout=0.0, attn_drop=0.0, global_emb=False, num_head=8, xseql=cache_len_default, ahsize=None, norm_output=True, bindDecoderEmb=True, forbidden_index=None, num_layer_pret=16, **kwargs):
		...
		self.enc = Encoder(isize, snwd, pnwd, enc_layer, fhsize, dropout, attn_drop, num_head, xseql, ahsize, norm_output, num_layer_pret)
