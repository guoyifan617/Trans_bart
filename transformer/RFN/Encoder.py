...
from modules.rfn import LSTMCell4FFN, SelfAttn#, rnncells import LSTMCell4RNMT as
...
class EncoderLayer(EncoderLayerBase):
	...
	def __init__(self, isize, fhsize=None, dropout=0.0, attn_drop=0.0, num_head=8, ahsize=None, norm_residual=norm_residual_default, k_rel_pos=use_k_relative_position_encoder, enable_sattn_outer=True, **kwargs):
	...
	def forward(self, inputs, cellin, mask=None, **kwargs):
		...
		return self.ff(context, (inputs, cellin))
