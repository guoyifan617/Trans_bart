...
from modules.rfn import LSTMCell4StdFFN as LSTMCell4FFN#, PositionwiseFF, rnncells import LSTMCell4RNMT as
...
class DecoderLayer(DecoderLayerBase):
	...
	def __init__(self, isize, fhsize=None, dropout=0.0, attn_drop=0.0, num_head=8, ahsize=None, norm_residual=norm_residual_default, k_rel_pos=use_k_relative_position_decoder, enable_ffn_res=False, **kwargs):
		...
		self.lstm = LSTMCell4FFN(isize, dropout=dropout)#, osize=isize, hsize=_fhsize, dropout=dropout
	...
	def forward(self, inpute, inputo, cellin, src_pad_mask=None, tgt_pad_mask=None, query_unit=None, **kwargs):
		...
		out, cellout = self.lstm(context, (lstmo, cellin))
