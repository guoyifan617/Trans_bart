...
class PositionwiseFF(PositionwiseFFBase):
	...
	def __init__(self, isize, hsize=None, dropout=0.0, act_dropout=None, num_head=None, head_dim=64, custom_act=use_adv_act_default, enable_bias=enable_prev_ln_bias_default, enable_proj_bias=enable_proj_bias_default, **kwargs):
