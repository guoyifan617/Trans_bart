...
class PositionwiseFF(PositionwiseFFBase):
	...
	def __init__(self, isize, hsize=None, dropout=0.0, norm_residual=norm_residual_default, kernel_size=5, ngroup=3, custom_act=use_adv_act_default, enable_bias=enable_prev_ln_bias_default, **kwargs):
