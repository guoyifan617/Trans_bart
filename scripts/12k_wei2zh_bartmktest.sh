...
export srcd=/home/yfguo/CCMT_model/bart_wright/transformer-edge/cache/12k_cache/wei2zh_bart
export srctf=src.dev.bpe
export modelf="/home/yfguo/CCMT_model/bart_wright/transformer-edge/expm/rs/std/12k_bart_wei2zh/step1/avg.h5"
export rsd=$srcd
...
export dataid=12k_wei2zh_trans
...
export src_vcb=/home/yfguo/CCMT_model/bart_wright/transformer-edge/cache/12k_cache/wei2zh_bart/rs1/srcvcb.txt
export bpef=out.bpe
...
wait
python 12k_wei_real_bart_predict.py $tgtd/$bpef $tgt_vcb $modelf &
wait
