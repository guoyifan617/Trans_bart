...
export modelf="/home/yfguo/CCMT_model/bart_wright/transformer-edge/expm/rs/std/16k_bart_meng2zh/step1/avg.h5"
export rsd=$srcd
...
export dataid=16k_meng2zh_trans
...
export src_vcb=/home/yfguo/CCMT_model/bart_wright/transformer-edge/cache/16k_Cache/meng2zh_bart/rs1/srcvcb.txt
export bpef=out.bpe
...
wait
python 16k_real_bart_predict.py $tgtd/$bpef $tgt_vcb $modelf &
wait
