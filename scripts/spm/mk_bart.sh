...
export cachedir=cache/24k_cache

export dataid=zh2meng_bart

export srcd=/home/yfguo/CCMT_model/bart_wright/transformer-edge/cache/24k_cache/zh2meng_bart
export srctf=src.train.zh
export tgttf=tgt.train.meng
export srcvf=src.dev.zh
export tgtvf=tgt.dev.meng
