...
export cachedir=cache/16k_cache_for_multi_with_enhan

export dataid=enhan

export srcd=/home/yfguo/CCMT_model/bart_wright/transformer-edge/cache/16k_cache_for_multi_with_enhan/enhan
export srctf=src.en.tc
export tgttf=tgt.zh
