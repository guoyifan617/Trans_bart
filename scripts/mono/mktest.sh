...
export srcd=mono14ed/test
export srctf=test.en.tc.mono14ed
export modelf="expm/mono14ed/mono/base/checkpoint.h5"
export rsd=mono14edtrs
...
python tools/mono/mkmono.py $srt_input_f $src_vcb $tgtd/test.h5 $ngpu
python predict_mono.py $tgtd/$bpef.srt $tgt_vcb $modelf
