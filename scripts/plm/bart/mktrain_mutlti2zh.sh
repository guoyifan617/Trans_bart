...
export cachedir=/home/yfguo/CCMT_model/bart_wright/transformer-edge/cache/
export dataid=16k_cache_for_multi_with_enhan

export srcd=$cachedir/$dataid
export srctf=src.train.min
export tgttf=tgt.train.han
export srcdf=src.dev.min
export tgtdf=tgt.dev.han
...
export src_vcb=$tgtd/srcvcb.txt
...
python /home/yfguo/CCMT_model/bart_wright/transformer-edge/tools/vocab/map.py $srcd/$srctf $src_vcb $tgtd/$srctf_id &
python /home/yfguo/CCMT_model/bart_wright/transformer-edge/tools/vocab/map.py $srcd/$srcdf $src_vcb $tgtd/$srcdf_id &
wait
