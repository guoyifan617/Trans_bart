...
export srcd=/home/yfguo/CCMT_model/bart_wright/transformer-edge/cache/16k_cache_for_multi_with_enhan
export srctf=src.dev.bpe.zang
export modelf="/home/yfguo/CCMT_model/bart_wright/transformer-edge/expm/rs/std/base_mbart_with_enhan_not_menghan/step1/avg.h5"
export rsd=$srcd
export reference=tgt.dev.zang.zh

export tgt_vcb=/home/yfguo/CCMT_model/bart_wright/bart-base-chinese/vocab.txt

export cachedir=cache
export dataid=16k_multi2zh_zang_enhan_trans

export ngpu=1

export sort_decode=false
...
export src_vcb=/home/yfguo/CCMT_model/bart_wright/transformer-edge/cache/16k_cache_for_multi_with_enhan/rs1/srcvcb.txt
export bpef=out.bpe
...
wait
python 16k_zang_multi_bart_enhan_predict.py $tgtd/$bpef $tgt_vcb $modelf &
wait
