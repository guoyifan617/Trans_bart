...
export srcd=/home/yfguo/CCMT_model/bart_wright/transformer-edge/cache/24k_cache/meng2zh_bart
export srctf=src.dev.bpe
export modelf="/home/yfguo/CCMT_model/bart_wright/transformer-edge/expm/rs/std/24kbpe_result/bart_meng2zh/step1/avg.h5"
export rsd=$srcd
...
export dataid=24k_meng2zh_trans
...
export src_vcb=/home/yfguo/CCMT_model/bart_wright/transformer-edge/cache/24k_cache/meng2zh_bart/rs1/srcvcb.txt
export bpef=out.bpe
...
wait
python real_bart_predict.py $tgtd/$bpef $tgt_vcb $modelf &
wait
