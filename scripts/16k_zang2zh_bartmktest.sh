...
export srcd=/home/yfguo/CCMT_model/bart_wright/transformer-edge/cache/16k_Cache/zang2zh_bart
export srctf=src.dev.bpe
export modelf="/home/yfguo/CCMT_model/bart_wright/transformer-edge/expm/rs/std/16k_bart_zang2zh/step1/avg.h5"
export rsd=$srcd
...
export dataid=16k_zang2zh_trans
...
export src_vcb=/home/yfguo/CCMT_model/bart_wright/transformer-edge/cache/16k_Cache/zang2zh_bart/rs1/srcvcb.txt
export bpef=out.bpe
...
wait
python 16k_zang_real_bart_predict.py $tgtd/$bpef $tgt_vcb $modelf &
wait
