...
export srcd=/home/yfguo/CCMT_model/bart_wright/transformer-edge/cache/16k_Cache/meng2zh_bart
export srctf=src.dev.bpe
export modelf="/home/yfguo/CCMT_model/bart_wright/transformer-edge/expm/rs/std/true_reverse_dict_16k_meng2zh/step1/avg.h5"
export rsd=$srcd
export reference=tgt.dev.zh

export tgt_vcb=/home/yfguo/CCMT_model/bart_wright/bart-base-chinese/vocab.txt

export cachedir=cache
export dataid=16k_meng2zh_true_reverse_dict_trans
...
export src_vcb=/home/yfguo/zh_data_for_vcb/meng2zh/meng_true_reverse_vcb.txt
export bpef=out.bpe
...
python /home/yfguo/CCMT_model/bart_wright/transformer-edge/tools/vocab/new_map.py $srcd/$srctf $src_vcb $stif &
wait
...
wait
python 16k_meng_real_bart_predict.py $tgtd/$bpef $tgt_vcb $modelf &
wait
