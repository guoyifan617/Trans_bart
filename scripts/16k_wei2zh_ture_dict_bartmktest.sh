...
export modelf="/home/yfguo/CCMT_model/bart_wright/transformer-edge/expm/rs/std/true_reverse_dict_16k_wei2zh/step1/avg.h5"
export rsd=$srcd
...
export dataid=16k_wei2zh_true_reverse_dict_trans
