...
def ldvocab(*args, sep=sep_load, **kwargs):

	return ldvocab_base(*args, sep=sep, **kwargs)

def save_vocab(*args, sep=sep_save, **kwargs):

	return save_vocab_base(*args, sep=sep, **kwargs)

def ldvocab_list(*args, sep=sep_load, **kwargs):

	return ldvocab_list_base(*args, sep=sep, **kwargs)

def ldvocab_freq(*args, sep=sep_load, **kwargs):

	return ldvocab_freq_base(*args, sep=sep, **kwargs)
